...
public class DispositivoElectronicoController {
	...
	public List<DispositivoElectronico> dispositivos() {
		return (List<DispositivoElectronico>) serviceDispositivoElectronico.buscarTodas();
	}

	@PostMapping("/save")
	public DispositivoElectronico guardar(@RequestBody DispositivoElectronicoDTO dispositivo) {
